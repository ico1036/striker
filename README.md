# STRIKER Flight Tracker

실시간 항공편 추적 애플리케이션으로, FlightAware 데이터를 활용하여 항공편의 실시간 위치와 경로를 추적합니다.
...
1. 서버를 시작하면 자동으로 항공편 데이터를 가져옵니다
